 ...
 */
public final class GmodelMetaModel implements MetaModel {

	private static final String NAME = GmodelMetaModel.class.getSimpleName();
	...
	public GmodelMetaModel(final Set set) {
