...
import org.s23m.cell.eclipse.openarchitectureware.GmodelMetaModel;
 ...
 */
public class GmodelGenerator extends AbstractWorkflowComponent {
	...
	private final GmodelMetaModel metaModel;

	private String templateName;

	private final Set set;

	public GmodelGenerator(final Set set) {
		this.set = set;
		this.metaModel = new GmodelMetaModel(set);
